...
public class MainActivity extends ActionBarActivity implements WeekView.MonthChangeListener,
    ...
    public List<WeekViewEvent> onMonthChange(int newYear, int newMonth) {
        ...
        if (!calendarLoad) {
            ...
            List<? extends WeekViewEvent> list = CalendarReader.getAllEvents(this, newYear, newMonth);
            return (List<WeekViewEvent>) list;
        }
    }
